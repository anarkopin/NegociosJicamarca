...
function Footer() {
  ...
  //cambiar de año automaticamente
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div
      className="flex flex-col items-center gap-4 rounded-lg bg-[#0D1950] p-6 shadow-lg sm:flex-row sm:justify-between"
    >
      <strong className="text-xl text-white sm:text-xl">
        Únete a la comunidad de Jicamarcanegocios.com
      </strong>
      ...
      <a
        ...
        href="/"
      >
        <span className="text-sm font-medium"> Unirme! </span>
    ...
    <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
      <div className="text-center sm:text-left">
        <p className="text-lg font-medium text-gray-900">Acerca de nosotros</p>
    ...
    <div className="mt-16">
      ...
      <div className="mt-16 sm:flex sm:items-center sm:justify-between">
        <div className="flex justify-center text-teal-600 sm:justify-start">
          <img src={logo} alt="Logo" className="  md:h-24"/>
        </div>
